                    ...
                    <form action="{{ route('inspecciones.store') }}" method="POST">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-3 col-md-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('propietario_nombre') }}" required pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ\s]+"
                            ...
                            <div class="col-lg-3 col-md-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('propietario_apellido') }}" required pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ\s]+"
                                    title="Solo se permiten letras y espacios">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('observacion') is-invalid @enderror" id="observacion"
                                ...
                                placeholder="Observación">{{ old('observacion') }}</textarea>
                            @error('observacion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
