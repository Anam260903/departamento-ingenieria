...
<body>
    ...
    <div class="list-group list-group-flush pt-4">
        ...
        <a href="{{ route('inspecciones.index') }}" class="list-group-item list-group-item-action bg-white d-flex align-items-center @if(request()->routeIs('inspecciones.index') || request()->routeIs('inspecciones.create') || request()->routeIs('inspecciones.edit')) active @endif">
