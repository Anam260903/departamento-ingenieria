        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid py-4">
                ...
                <div class="card shadow-sm p-4">
                    ...
                    {{-- La clave es el método POST con la directiva @method('PUT') --}}
                    <form action="{{ route('inspecciones.update', $inspeccion->id_insp) }}" method="POST">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('fecha') is-invalid @enderror" id="fecha" name="fecha" value="{{ old('fecha', $inspeccion->fecha_insp) }}" required>
                                @error('fecha')
                        ...
                        <h5 class="mb-3">Datos del Propietario (Se modificará el registro existente si se cambia la información)</h5>
                        <div class="row mb-4">
                            {{-- Nombre --}}
                            ...
                            {{-- Cédula (Debe ser única y es la clave para la búsqueda/actualización) --}}
                            <div class="col-lg-3 col-md-6 mb-3">
                                <label for="propietario_cedula" class="form-label">Cédula</label>
                                <input type="text" class="form-control @error('propietario_cedula') is-invalid @enderror" id="propietario_cedula" name="propietario_cedula" placeholder="Cédula del propietario" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="8" value="{{ old('propietario_cedula', $inspeccion->vivienda->propietario->cedula_propie ?? '') }}" required>
                            ...
                            <div class="col-lg-3 col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('propietario_telefono') is-invalid @enderror" id="propietario_telefono" name="propietario_telefono" placeholder="Teléfono del propietario" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="11" value="{{ old('propietario_telefono', $inspeccion->vivienda->propietario->telefono ?? '') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('direccion') is-invalid @enderror" id="direccion" name="direccion" placeholder="Ubicación de la vivienda" maxlength="100" value="{{ old('direccion', $inspeccion->vivienda->direccion ?? '') }}" required>
                            @error('direccion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('observacion') is-invalid @enderror" id="observacion" name="observacion" rows="3" maxlength="250" placeholder="Observación" >{{ old('observacion', $inspeccion->observacion) }}</textarea>
                            @error('observacion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
